* C:\Users\Admin\Documents\LTspiceXVII\fivebit.asc
XX1 N008 N007 N004 N003 N001 N006 N002 fourbit
XX2 N008 N007 N004 N003 N006 0 N009 fourbit
XX3 N010 N002 N009 N005 switch
V1 N001 0 3.3
V2 N008 0 PULSE(0 1.8 1p 1n 1n 50n 100n)
V3 N007 0 PULSE(0 1.8 1p 1n 1n 100n 200n)
V4 N004 0 PULSE(0 1.8 1p 1n 1n 200n 400n)
V5 N003 0 PULSE(0 1.8 1p 1n 1n 400n 800n)
V6 N010 0 PULSE(0 1.8 1p 1n 1n 800n 1600n)
